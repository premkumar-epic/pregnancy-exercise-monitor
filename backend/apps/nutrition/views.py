...
from apps.nutrition.serializers import NutritionCategorySerializer, NutritionFoodSerializer, NutritionTipSerializer
...
def nutrition_recommended(request):
    ...
    try:
        from exercise.models import PregnancyProfile
